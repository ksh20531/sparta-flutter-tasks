...
import 'package:flutter_markte_app/ui/pages/home/_tab/my_tab/widgets/my_profile_box.dart';
    ...
    return SafeArea(
      child: ListView(
        ...
        children: [
          ...
          SizedBox(height: 8),
          label('나의 거래'),
          item(text: '관심 목록', icon: CupertinoIcons.heart),
          item(text: '판매 내역', icon: CupertinoIcons.square_list),
          item(text: '구매 내역', icon: CupertinoIcons.bag),
          item(text: '중고 거래 가계부', icon: CupertinoIcons.book),
          Divider(),
          label('나의 소식'),
